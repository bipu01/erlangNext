...
import { makeFailedCardVisible, toggleLoading } from "@/redux/features/postPopupSlice";
...
const FormLayout = () => {
    ...
    return (
        <>
            <label htmlFor="title">
                <h1 className="mt-8 font-semibold mb-2 text-primaryBlue">Name of the product:</h1>
                <textarea
                    required
                    name="title"
                    id="title"
            ...
            <label htmlFor="des">
                <h1 className="mt-8 font-semibold mb-2 text-primaryBlue">Description the post:</h1>
                <textarea
                    required
                    name="desc"
                    id="desc"
            ...
            <label htmlFor="price">
                <h1 className="mt-8 font-semibold mb-2 text-primaryBlue">Price of the product:</h1>
                <input
                    required
                    type="number"
                    id="price"
