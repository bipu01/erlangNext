...
const NotLoggedPopup = () => {
  ...
  return (
    <>
      ...
      ></div>
      <div className="fixed top-25vh left-5vw sm:left-20vw z-40 flex flex-col p-8 pb-16 justify-between items-center h-30vh w-90vw sm:w-60vw backdrop-blur-xl bg-primaryBlue/80 text-white rounded-md ">
